...
public:
	...
	static std::size_t stackSize(IRGenerationContext _context, Type _type)
	{
		...
		else
		{
			...
			std::vector<TypeEnvironment::UnificationFailure> failures = env.unify(genericFunctionType, underlyingType);
